...
namespace BusinessDVLDLayer
{
    public class clsTest
    {
        ...
        private bool _AddNewTest()
        {
            ...
            this.TestID = clsDataTest.AddNewTest(this.TestAppointmentID,
        ...
        private bool _UpdateTest()
        {
            ...
            return clsDataTest.UpdateTest(this.TestID, this.TestAppointmentID,
                this.TestResult, this.Notes, this.CreatedByUserID);
        }
        ...
        public static clsTest Find(int TestID)
        {
            ...
            if (clsDataTest.GetTestInfoByID(TestID,
            ...
            (int PersonID, int LicenseClassID, clsTestType.enTestType TestTypeID)
        {
            ...
            if (clsDataTest.GetLastTestByPersonAndTestTypeAndLicenseClass
        ...
        {
            return clsDataTest.GetPassedTestCount(LocalDrivingLicenseApplicationID);
        }
