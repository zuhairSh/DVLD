...
namespace DVLD.MyContors
{
    public partial class ScheduleTest : UserControl
    {
        ...
        public void LoadInfo(int LocalDrivingLicenseApplicationID, int TestAppointmentID = -1)
        {
            ...
            this._LocalDrivingLicenseApplication = 
            ...
            if(_LocalDrivingLicenseApplication.TotalTrialsPerTest(TestTypeID) > 0)
            ...
            {
                lblRetakeAppFees.Text = clsApplicationTypes.FindApplicationType((int)clsApplication.enApplicationType.RetakeTest).ApplicationFees.ToString();
            ...
            {
                lblFees.Text = clsTestType.FindTestType(_TestTypeID).TestTypeFees.ToString();
        ...
        private bool _HandleRetakeApplication()
        {
            ...
            if (_Mode == enMode.AddNew && _CreationMode == enCreationMode.RetakeTestSchedule)
            {
                ...
                Application.PaidFees = clsApplicationTypes.FindApplicationType((int)clsApplication.enApplicationType.RetakeTest).ApplicationFees;
                Application.CreatedByUserID = GlobalClass.clsSettingLogin.CurretUser.UserID;
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            _TestAppointment.CreatedByUserID = GlobalClass.clsSettingLogin.CurretUser.UserID;
